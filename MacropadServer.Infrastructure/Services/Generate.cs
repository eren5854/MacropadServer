...
{
    public void GenerateMacropadInput(Macropad macropad)
    {
        int buttonCount = macropad.MacropadModel!.ButtonCount;
        int modCount = macropad.MacropadModel.ModCount;
